...
- Simple is beautiful; added complexity must justify itself.
- Keep related code close together (same file, directory, naming patterns).
- Separated code should include comments noting its callers to preserve flow.
